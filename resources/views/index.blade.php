                            ...
                            <div uk-drop="mode: click" class="header_dropdown">
                                 <div  class="dropdown_scrollbar" data-simplebar>
                                     ...
                                     <ul>
                                         ...
                                         <li class="not-read">
                                             <a href="#">
                                                 <div class="drop_avatar status-online"> <img src="images/avatars/avatar-2.jpg" alt="">
                                                 </div>
                                                 <div class="drop_text">
                                                     <p>
                        ...
                        <div class="user_story grid md:grid-cols-5 grid-cols-3 gap-2 lg:-mx-20 relative">
                            ...
                            <a href="#create-post" uk-toggle="target: body ; cls: story-active">
                                <div class="single_story">
                                    <img src="images/avatars/avatar-lg-1.jpg" alt="">
                                    <div class="story-avatar"> <img src="images/avatars/avatar-6.jpg" alt=""></div>
                                    <div class="story-content"> <h4>Erica Jones </h4> </div>
                                </div>
                            </a>
                            <a href="#" uk-toggle="target: body ; cls: story-active">
                                <div class="single_story">
                                    <img src="images/avatars/avatar-lg-2.jpg" alt="">
                                    <div class="story-avatar"> <img src="images/avatars/avatar-2.jpg" alt=""></div>
                                    <div class="story-content"> <h4>  Dennis Han</h4> </div>
                                </div>
                            </a>
                            <a href="#" uk-toggle="target: body ; cls: story-active">
                                <div class="single_story">
                                    <img src="images/avatars/avatar-lg-3.jpg" alt="">
                                    <div class="story-avatar"> <img src="images/avatars/avatar-3.jpg" alt=""></div>
                                    <div class="story-content"> <h4> Alex Mohani</h4> </div>
                                </div>
                            </a>
                            <a href="#" uk-toggle="target: body ; cls: story-active">
                                <div class="single_story">
                                    <img src="images/avatars/avatar-lg-4.jpg" alt="">
                                    <div class="story-avatar"> <img src="images/avatars/avatar-4.jpg" alt=""></div>
                                    <div class="story-content"> <h4> Jonathan </h4> </div>
                                </div>
                            </a>
                            <a href="#" uk-toggle="target: body ; cls: story-active">
                                <div class="single_story">
                                    <img src="images/avatars/avatar-lg-5.jpg" alt="">
                                    <div class="story-avatar"> <img src="images/avatars/avatar-5.jpg" alt=""></div>
                        ...
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                            ...
                            <div uk-lightbox>
                                <div class="grid grid-cols-2 gap-2 px-5">
                                    ...
                                    <a href="images/post/img-4.jpg" class="col-span-2">  
                                        <img src="images/post/img-4.jpg" alt="" class="rounded-md w-full lg:h-76 object-cover">
                                    </a>
                                    <a href="images/post/img-4.jpg">  
                                        <img src="images/post/img-2.jpg" alt="" class="rounded-md w-full h-full">
                                    </a>
                                    <a href="images/post/img-4.jpg" class="relative">  
                                        <img src="images/post/img-3.jpg" alt="" class="rounded-md w-full h-full">
            ...
            <div class="space-y-6">
                <div class="sm:space-y-8 space-y-6 pb-2">
                    ...
                    <div class="flex items-center sm:space-x-6 space-x-3">
                        <img src="images/avatars/avatar-3.jpg" alt="" class="sm:w-16 sm:h-16 w-14 h-14 rounded-full">
                        <div class="flex-1">
                    ...
                    <div class="flex items-center sm:space-x-6 space-x-3">
                        <img src="images/avatars/avatar-2.jpg" alt="" class="sm:w-16 sm:h-16 w-14 h-14 rounded-full">
                        <div class="flex-1">
                            <div class="flex items-center justify-between mb-3">
                ...
                <div class="mt-5 sm:space-y-8 space-y-6" id="upcoming" hidden>
                    ...
                    <div class="flex items-center sm:space-x-6 space-x-3">
                        <img src="images/avatars/avatar-6.jpg" alt="" class="sm:w-16 sm:h-16 w-14 h-14 rounded-full">
                        <div class="flex-1">
                            <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex items-center sm:space-x-6 space-x-3">
                        <img src="images/avatars/avatar-5.jpg" alt="" class="sm:w-16 sm:h-16 w-14 h-14 rounded-full">
                        <div class="flex-1">
                            <div class="flex items-center justify-between mb-3">
