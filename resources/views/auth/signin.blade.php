...
<!-- Mirrored from demo.foxthemes.net/socialite/form-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jul 2023 09:23:31 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div id="wrapper" class="flex flex-col justify-between h-screen">
                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="flex items-center lg:justify-between justify-around">
                        ...
                        <div class="capitalize flex font-semibold hidden lg:block my-2 space-x-3 text-center text-sm">
                            <a href="{{Route("signup")}}" class="bg-purple-500 purple-500 px-6 py-3 rounded-md shadow text-white">Register</a>
                        </div>
            ...
            <div>
                <div class="lg:p-12 max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
                    ...
                    <form class="lg:p-10 p-6 space-y-3 relative bg-white shadow-xl rounded-md" action="{{ Route("signin") }}" method="POST">
                        @csrf
